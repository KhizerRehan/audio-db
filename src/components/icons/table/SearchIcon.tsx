...
export const SearchIcon: React.FC<IconProps> = ({ width, height, theme }: IconProps) => {
  const [fill, setFill] = useState<string>("")
  useEffect(() => {
    const newFill = theme === "dark" ? "#FFFFFF" : "#252F3E"
    setFill(newFill)
  }, [theme])
  ...
  return (
    <svg width={width} height={height} viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M15.989 15.4905L19.5 19.0015" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"
